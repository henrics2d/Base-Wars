...
function tdm.hitTalents(id, source, weapon, hpdmg, apdmg, rawdmg, obj)
  ...
  if sourceid ~= nil then
    if sourceid.name == "Engage" or sourceid.name == "Hermes' Gun" or sourceid.name == "Critical Attack" or sourceid.name == "Heavens' Striker" or sourceid.name == "Hell's Partisan" or sourceid.name == "Meteor Shot" or sourceid.name == "Solar Eruption" or sourceid.name == "Lunar Demon" then
